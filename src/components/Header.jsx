    ...
    <div className="relative">
                ...
                {user && user.email === "bilalmlym@gmail.com" && (
                  ...
                  <ul className="flex  flex-col">
                    ...
                    <li  className="text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-200 px-4 py-2">Services</li>
