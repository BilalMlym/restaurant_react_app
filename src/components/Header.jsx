...
<header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary opacity-95">
  ...
  <div className="hidden md:flex w-full h-full items-center justify-between">
    <Link to={"/"} className='flex items-center gap-2'>
      <img src={Logo} className="w-14 h-14 rounded-full object-cover" alt="logo"/>
      <p className="text-textColor text-2xl font-bold">BrotherS</p>
    </Link>
    ...
    <div
      ...
      <div className="flex items-center justify-between md:hidden w-full h-full ">
        ...
        <Link to={"/"} className="flex items-center gap-2">
          <img src={Logo} className="w-14 h-14 object-cover rounded-full" alt="logo" />
          <p className="text-textColor text-xl font-bold">BrotherS</p>
